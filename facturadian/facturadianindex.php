...
/**
 *	\file       facturadian/facturadianindex.php
 *	\ingroup    facturadian
 *	\brief      Home page of facturadian top menu
 */
...
print load_fiche_titre($langs->trans("FacturaDian"), '', 'facturadian.png@facturadian');

print "<iframe src='https://portal.facturadian.com' style='border: 0; margin: 0; width: 100%' height='800'></iframe>";
...
// Draft MyObject
if (! empty($conf->facturadian->enabled) && $user->rights->facturadian->read)
{
	$langs->load("orders");
