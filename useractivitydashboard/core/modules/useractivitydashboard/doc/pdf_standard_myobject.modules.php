...
/**
 *  \file       useractivitydashboard/core/modules/useractivitydashboard/doc/pdf_standard.modules.php
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		*/
	    ...
	    if ($conf->useractivitydashboard->dir_output.'/myobject')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->useractivitydashboard->dir_output.'/myobject';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->useractivitydashboard->dir_output.'/myobject/'.$objectref;
