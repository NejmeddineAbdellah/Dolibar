...
INNER JOIN ".PREFIJO."_c_payment_term AS payment
ON fac.fk_cond_reglement = payment.rowid
WHERE NOT extra.envio AND fac.type = '3' AND LEFT(fac.ref,1) <> '(' AND UPPER(LEFT(fac.ref,1)) <> 'U' AND fac.ref LIKE '".DOCUMENT."%' ORDER BY fac.ref
LIMIT ".LIMITE;
