...
// VERIFICAR EN DIAN
$cadena = " 
SELECT fac.ref AS facnumber,fac.datef AS datef,extra.zipkey AS zipkey
FROM ".PREFIJO."_facture AS fac
INNER JOIN ".PREFIJO."_facture_extrafields AS extra
ON fac.rowid = extra.fk_object
WHERE extra.envio AND (extra.isvalid = '-' OR extra.isvalid = 'false') ORDER BY fac.ref
";
...
while($row = $result->fetch_array(MYSQLI_ASSOC)) {
	...
	echo "===> Verificando en la DIAN el documento: ".$prefijo.$numero."\n";
	//echo $json;
