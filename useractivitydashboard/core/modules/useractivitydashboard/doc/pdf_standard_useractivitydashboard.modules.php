...
/**
 *  \file       core/modules/useractivitydashboard/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_useractivitydashboard
 */
class pdf_standard_useractivitydashboard extends ModelePDFUserActivityDashboard
{
    /**
	...
	*/
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
	    ...
	    /*
	    if (!empty($conf->global->MAIN_GENERATE_USERACTIVITYDASHBOARD_WITH_PICTURE))
	    {
		...
		*/
	    ...
	    if ($conf->useractivitydashboard->dir_output.'/useractivitydashboard')
	    {
	        ...
	        if ($object->specimen)
	        {
	        	$dir = $conf->useractivitydashboard->dir_output.'/useractivitydashboard';
	            $file = $dir."/SPECIMEN.pdf";
	        } else {
	            $objectref = dol_sanitizeFileName($object->ref);
	            $dir = $conf->useractivitydashboard->dir_output.'/useractivitydashboard/'.$objectref;
