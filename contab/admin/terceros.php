...
$h2 = 0;
$head2[$h2][0]="terceros.php?mod=1"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Configuracion de Polizas"; // Titre de l'ongLet
$head2[$h2][2]="Configuracion de Polizas";
$h2++;
$head2[$h2][0]="terceros.php?mod=2"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Vinculacion de Cuentas con Terceros"; // Titre de l'ongLet
$head2[$h2][2]="Vinculacion de Cuentas con Terceros";
$h2++;
if(GETPOST('mod')==1){
	$mod=1;
}else{
...
if($mod==1){
	dol_fiche_head($head2, '0', 'Reportes', 0, '');
}else{
	if($mod==2){
		dol_fiche_head($head2, '1', 'Reportes', 0, '');
	}
}

if($mod==1){
	if($user->rights->contab->ccterceros){
		include "config_permgenera_poliza.php";
	}else{
