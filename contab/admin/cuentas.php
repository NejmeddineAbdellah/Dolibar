...
$h2 = 0;
$head2[$h2][0]="cuentas.php?mod=1"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Configuracion de Cuentas"; // Titre de l'ongLet
$head2[$h2][2]="Configuracion de Cuentas";
$h2++;
$head2[$h2][0]="cuentas.php?mod=2"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Asignacion de Cuentas Personalizadas"; // Titre de l'ongLet
$head2[$h2][2]="Asignacion de Cuentas Personalizadas";
$h2++;
$head2[$h2][0]="cuentas.php?mod=3"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Cat. Principal"; // Titre de l'ongLet
$head2[$h2][2]="Cat. Principal";
$h2++;
$head2[$h2][0]="cuentas.php?mod=4"; // Url de la page affichée quand on clique sur l'onglet
$head2[$h2][1]="Cat. del Usuario"; // Titre de l'ongLet
$head2[$h2][2]="Cat. del Usuario";
$h2++;
if(GETPOST('mod')==1){
	$mod=1;
}else{
...
if($mod==1){
	dol_fiche_head($head2, '0', 'Cuentas', 0, '');
}else{
	if($mod==2){
		dol_fiche_head($head2, '1', 'Cuentas', 0, '');
	}else{
		if(GETPOST('mod')==3){
			dol_fiche_head($head2, '2', 'Cuentas', 0, '');
		}else{
			if(GETPOST('mod')==4){
				dol_fiche_head($head2, '3', 'Cuentas', 0, '');
			}
		}
	}
}
...
if($mod==1){
	if($user->rights->contab->conscatcuenta){
		include "config_ctas_aut.php";
	}else{
