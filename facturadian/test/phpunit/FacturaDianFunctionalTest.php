...
/**
 * \file    test/functional/FacturaDianFunctionalTest.php
 * \ingroup facturadian
...
/**
 * Class FacturaDianFunctionalTest
 *
 ...
 *
 * @package Testfacturadian
 */
class FacturaDianFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modFacturaDian')->click();
		} else {
			// Disable the module
			$this->byHref('modFacturaDian')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/facturadian/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('facturadian/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/facturadian/admin/about.php');
		$this->authenticate();
		return $this->assertContains('facturadian/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('facturadianwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modFacturaDian_FacturaDianTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modFacturaDian_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
