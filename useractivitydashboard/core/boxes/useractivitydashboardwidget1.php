...
/**
 * \file    useractivitydashboard/core/boxes/useractivitydashboardwidget1.php
 * \ingroup useractivitydashboard
 * \brief   Widget provided by UserActivityDashboard
 *
 ...
 */
class useractivitydashboardwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "useractivitydashboardbox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "useractivitydashboard@useractivitydashboard";
	 ...
	 */
	public $depends = array('useractivitydashboard');
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		//$this->hidden = ! ($user->rights->useractivitydashboard->myobject->read);   // Condition when module is visible by user (test on permission)
	}
	...
	public function loadBox($max = 5)
	{
		...
		$text = $langs->trans("UserActivityDashboardBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_useractivitydashboard@useractivitydashboard',
